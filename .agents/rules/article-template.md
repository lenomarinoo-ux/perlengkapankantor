...
2. **SELALU** menggunakan sistem kelas `.scf-*` yang sudah terdefinisi di `assets/css/style.css`.
3. **SELALU** menambahkan kartu artikel ke `blog.html` (posisi teratas grid) dan URL baru ke `sitemap.xml`.
